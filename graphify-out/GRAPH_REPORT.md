...
## Corpus Check
- 282 files · ~167,349 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3704 nodes · 5215 edges · 223 communities (196 shown, 27 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 71 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d025a0de`
...
- `WearableCreate` --uses--> `WearableDevice`  [INFERRED]
  backend/app/routers/wearables.py → backend/app/services/wearable_service.py
- `HealthUpdate` --uses--> `WearableDevice`  [INFERRED]
  backend/app/routers/wearables.py → backend/app/services/wearable_service.py
- `ClientInfo` --uses--> `ObservationConfig`  [INFERRED]
  backend/app/routers/websocket.py → backend/app/services/vision_service.py
- `ClientInfo` --uses--> `ObservationMode`  [INFERRED]
  backend/app/routers/websocket.py → backend/app/services/vision_service.py
...
Cohesion: 0.03
Nodes (59): _addChatMessage, _avatarState, _avatarSubscription, _bg, build, _buildAvatarSection, _buildBottomPanel, _buildChatHistory (+51 more)
...
Cohesion: 0.07
Nodes (28): _bg, build, _buildDetailRow, _buildDeviceDetailsSheet, _buildDeviceList, _buildFilterBar, _buildFilterChip, _buildSummaryBar (+20 more)

### Community 11 - "camera_screen.dart"
Cohesion: 0.04
Nodes (45): _alertSubscription, _analyzeCurrentCamera, _askQuestion, _bg, build, _buildActionButton, _buildCameraCard, _buildCameraList (+37 more)

### Community 12 - "onboarding_screen.dart"
Cohesion: 0.05
Nodes (41): _authToken, build, _buildCompleteStep, _buildConnectionResult, _buildConnectStep, _buildHudButton, _buildProfileStep, _buildServerInfo (+33 more)
...
Cohesion: 0.04
Nodes (46): camera_screen.dart, _bg, build, _buildBody, _buildDrawerHeader, _buildNav, _cameraService, createState (+38 more)

### Community 16 - "settings_screen.dart"
Cohesion: 0.05
Nodes (44): _bg, _buildDeviceTile, _buildSection, _buildSwitchTile, _buildTapTile, _configMissing, createState, _darkMode (+36 more)
...
Cohesion: 0.23
Nodes (19): add_device(), detect_capabilities(), detect_device_capabilities(), device_heartbeat(), device_status_summary(), _device_to_dict(), DeviceCreate, DeviceUpdate (+11 more)

### Community 28 - "screen_share_screen.dart"
Cohesion: 0.06
Nodes (34): _analysisResult, _analysisSubscription, _bg, build, _buildAnalysisPanel, _buildControlBar, _buildControlButton, _buildViewer (+26 more)

### Community 29 - "overlay_widget.dart"
Cohesion: 0.06
Nodes (36): _avatarState, _bg, build, _buildControls, _buildHealthBar, _buildMenuButton, _buildTitleBar, _connect (+28 more)
...
Cohesion: 0.08
Nodes (26): _bg, build, _buildColorPicker, _buildControlSheet, _buildDeviceCard, _buildDeviceGrid, _buildNoDevices, _buildRoomFilter (+18 more)
...
Cohesion: 0.08
Nodes (25): _bg, build, _buildAlertsSection, _buildBatteryIndicator, _buildDeviceHeader, _buildHealthDashboard, _buildNoDevice, _buildStatusChip (+17 more)

### Community 37 - "wearable_service.dart"
Cohesion: 0.09
Nodes (22): _alertController, alerts, allDevices, baseUrl, _deviceController, devices, dispose, fetchDevices (+14 more)
...
Cohesion: 0.08
Nodes (24): addDevice, allDevices, baseUrl, connectMQTT, _control, _deviceController, _devices, deviceUpdates (+16 more)
...
### Community 44 - "test_voice_session.py"
Cohesion: 0.07
Nodes (50): _load_vad(), _load_wake_model(), _pcm_to_wav(), Enum, Server-side voice session: openWakeWord wake detection + Silero VAD command…, SessionPhase, strip_wake_phrase(), VoiceSession (+42 more)
...
Cohesion: 0.11
Nodes (17): AnimationController, build, _color, _controller, createState, currentState, didUpdateWidget, dispose (+9 more)
...
Cohesion: 0.09
Nodes (5): Routine, RoutineService, RoutineStep, HealthSummary, WearableService
...
Cohesion: 0.08
Nodes (23): baseUrl, getStatus, learnOpinion, PersonalityService, setFeedback, setName, updateStyle, applyTier (+15 more)
...
Cohesion: 0.18
Nodes (20): analyze_camera(), describe_for_command(), get_observation_history(), get_observation_session(), get_observation_sessions(), get_vision_cameras(), ObservationStart, BaseModel (+12 more)
...
### Community 203 - "WearableDevice"
Cohesion: 0.20
Nodes (11): broadcast(), _broadcast_voice_alert(), ClientInfo, handle_device_heartbeat(), handle_device_register(), handle_device_status_update(), handle_screen_start(), handle_screen_stop() (+3 more)
...
### Community 217 - "State"
Cohesion: 0.20
Nodes (15): JarvisApp, _JarvisAppState, DevicesScreen, _DevicesScreenState, OnboardingScreen, _OnboardingScreenState, SpecsCheckScreen, _SpecsCheckScreenState (+7 more)

### Community 218 - "wearables.py"
Cohesion: 0.22
Nodes (14): get_alerts(), get_health_history(), get_health_summary(), get_wearable(), get_wearables(), HealthUpdate, BaseModel, delete (+6 more)
...
### Community 222 - "MaterialPageRoute"
Cohesion: 0.40
Nodes (5): _buildDrawer, _pushScreen, _enterFullscreen, build, MaterialPageRoute

## Knowledge Gaps
- **1808 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `crypto`, `http`, `fs` (+1803 more)
...
- **Why does `WearableDevice` connect `WearableDevice` to `websocket.py`, `wearable_screen.dart`, `WearableService`, `health_screen.dart`, `wearables.py`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `SystemCommandService` connect `SystemCommandService` to `DateTime`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `MotionDetectorPlugin` connect `DevicePlugin` to `main.py`?**
